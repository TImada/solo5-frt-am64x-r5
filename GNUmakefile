...
INCLUDES_device := \
	...
	-I${MCU_SDK_TOP}/source/networking/lwip/lwip-port/freertos/include \
	-I${MCU_SDK_TOP}/examples/networking/lwip/enet_lwip_icssg/extPhyMgmt \
	-I./ \
	-Igenerated
DEFINES_device := -DSOC_AM64X
CFLAGS_device := \
...
FILES := $(FILES_device) $(FILES_frt)
ASMFILES := $(ASMFILES_device) $(ASMFILES_frt)
FILES_PATH := $(FILES_PATH_device) $(FILES_PATH_frt)
CFLAGS := $(CFLAGS_device) $(CFLAGS_frt)
DEFINES := $(DEFINES_device) $(DEFINES_frt)
INCLUDES := $(INCLUDES_device) $(INCLUDE_frt)
